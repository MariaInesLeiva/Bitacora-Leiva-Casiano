using L13__LC_MI__1089524;
class Program
{
    static void Main(string[] args)
    {
        Matriz operacionesMatrices = new Matriz();
        char opcion = 'a';
        ...
        while (opcion != 'd')
        {
            ...
            switch (opcion)
            {
                case 'a':
                    ...
                    break;
                case 'b':
                    Console.WriteLine("Ingrese el número que desa buscar :)");
                    int numeroBuscado = int.Parse(Console.ReadLine());
                    operacionesMatrices.EncontrarNumero(numeroBuscado);
